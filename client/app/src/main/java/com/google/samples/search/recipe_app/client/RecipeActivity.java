...
import com.google.samples.search.recipe_app.client.content_provider.RecipeContentProvider;
...
public class RecipeActivity extends Activity {
    ...
    private RecipeApplication analytics = new RecipeApplication();
    ...
    public void onStart(){
        ...
        if (recipe != null) {
            ...
            analytics.trackScreenView(getIntent(), TITLE);
