...
package com.google.samples.search.recipe_app.client.content_provider;
...
import com.google.samples.search.recipe_app.database.RecipeIngredientTable;
import com.google.samples.search.recipe_app.database.RecipeInstructionsTable;
import com.google.samples.search.recipe_app.database.RecipeTable;

/**
 * This class fetches recipes, ingredients, and instructions from the database.
 */
public class RecipeContentProvider extends ContentProvider {

    // mDatabase
    private RecipeDatabaseHelper mDatabase;
    ...
    private static final String AUTHORITY = "com.google.samples.search.recipe_app";
    ...
    public boolean onCreate() {
        mDatabase = new RecipeDatabaseHelper(getContext());
        return false;
    }
    ...
    /**
     * This helper loads the SQLite mDatabase included with the app
